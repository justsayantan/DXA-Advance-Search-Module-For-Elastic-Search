...
namespace SI4T.Query.Solr
{
    ...
    public class Connection
    {
		...
		public ElasticSearchResult ExecuteQuery(NameValueCollection parameters)
        {
            var results = new ElasticSearchResult();
            try
            {
		...
		protected ElasticSearchResult ProcessResults(ElasticSearchResult results, string data)
		{
